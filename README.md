...
I work with **end-to-end projects**, from data collection and transformation (ETL/ELT), through exploratory analysis, Machine Learning models, to dashboards and data-driven applications.

I have a strong interest in **AI applied to business**, especially using modern tools like Python, SQL, TensorFlow, PyTorch and Cloud solutions.
...
- Application of Data Science methodologies to solve real institutional challenges during the competition.
- Experience with teamwork, problem-solving, time-critical execution and presenting analytical solutions aligned with institutional values.
...
- Contribution to the chatbot’s design, data handling strategy, and interaction flow to support event participants.
- Collaboration with multidisciplinary teams to integrate Data Science concepts into an applied real-world solution.
...
- Theoretical and field research for software development based on market competitors.

**Back-End System Analyst – Jul 2023 / Dec 2023**
- Participation in prototyping the web system and integrating it with the API.
- Web system development using Visual Studio as the IDE.
- Collaboration in a multidisciplinary team using Trello to ensure timely project delivery.

---

## 🌐 Contact
📧 **E-mail:** felipeciprianoafw@gmail.com  
📞 **Phone:** +55 (11) 94050-1092  
🔗 **LinkedIn:** [linkedin.com/in/felipe-cipriano-de-andrade-ferreira](https://linkedin.com/in/felipe-cipriano-de-andrade-ferreira)  
🐙 **GitHub:** [github.com/FelipeCipDev](https://github.com/FelipeCipDev)  
